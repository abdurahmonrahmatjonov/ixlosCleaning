			...
			>
				<div className="absolute inset-0 flex items-center ml-20 mb-32 justify-start ">
					<div className="flex flex-col">
						<span className="text-white hover:text-blue-400 text-7xl font-sans font-semibold  p-3">
							{slideImages[currentIndex].caption}
						</span>
						<span className="text-gray-200		 text-lg p-3">{slideImages[currentIndex].comment}</span>
					</div>
				</div>
